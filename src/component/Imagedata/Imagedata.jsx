...
import "../Imagedata/Imagedata.css";
...
const Imagedata = [
    {
        ...
        url: '../../../public/img/arnolfini-portrait/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/Arnolfini_Portrait",
        additionalUrl: '../../../public/img/arnolfini-portrait/artist.jpg'
    ...
    },
    {
        ...
        url:'../../../public/img/girl-with-pearl-earring/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/Girl_with_a_Pearl_Earring",
        additionalUrl: '../../../public/img/girl-with-pearl-earring/artist.jpg'
    ...
    },
    {
        ...
        url: '../../../public/img/guernica/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/Guernica_(Picasso)",
        additionalUrl: '../../../public/img/Guernica/artist.jpg'
    },
    {
        id: 4,
        ...
        url: '../../../public/img/lady-with-an-ermine/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/Lady_with_an_Ermine",
        additionalUrl: '../../../public/img/lady-with-an-ermine/artist.jpg'
    },
    {
        id: 5,
        ...
        url: '../../../public/img/penitent-magdalene/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/Penitent_Magdalene_(Artemisia_Gentileschi)",
        additionalUrl: '../../../public/img/penitent-magdalene/artist.jpg'
    },
    {
        id: 6,
        title: 'Starry Night',
        ...
        url: '../../../public/img/starry-night/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/The_Starry_Night",
        additionalUrl: '../../../public/img/starry-night/artist.jpg'
    },
    {
        id: 7,
        ...
        url: '../../../public/img/the-basket-of-apples/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/The_Basket_of_Apples",
        additionalUrl: '../../../public/img/the-basket-of-apples/artist.jpg'
    },
    {
        id: 8,
        ...
        url: '../../../public/img/the-boy-in-the-red-vest/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/The_Boy_in_the_Red_Vest",
        additionalUrl: '../../../public/the-boy-in-the-red-vest/artist.jpg'
    },
    {
        id: 9,
        ...
        url: '../../../public/img/the-great-wave-off-kanagawa/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/The_Great_Wave_off_Kanagawa",
        additionalUrl: '../../../public/the-great-wave-off-kanagawa/artist.jpg'
    },
    {
        id: 10,
        ...
        url: '../../../public/img/the-night-cafe/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/The_Night_Caf%C3%A9",
        additionalUrl: '../../../public/the-night-cafe/artist.jpg'
    },
    {
        id: 11,
        title: 'Mona Lisa',
        ...
        url: '../../../public/img/mona-lisa/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/Mona_Lisa",
        additionalUrl: '../../../public/mona-lisa/artist.jpg'
    },
    {
        id: 12,
        ...
        url: '../../../public/img/the-sleeping-gypsy/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/The_Sleeping_Gypsy",
        additionalUrl: '../../../public/wiki/artist.jpg'
    },
    {
        id: 13,
        ...
        url: '../../../public/img/the-storm-on-the-sea-of-galilee/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/The_Storm_on_the_Sea_of_Galilee",
        additionalUrl: '../../../public/the-storm-on-the-sea-of-galilee/artist.jpg'
    },
    {
        id: 14,
        title: 'The Swing',
        ...
        url: '../../../public/img/the-swing/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/The_Swing_(Fragonard)",
        additionalUrl: '../../../public/the-swing/artist.jpg'
    ...
    },
    {
        ...
        url: '../../../public/img/van-gogh-self-portrait/thumbnail.jpg',
        source: "https://en.wikipedia.org/wiki/Van_Gogh_self-portrait_(1889)",
        additionalUrl: '../../../public/an-gogh-self-portrait/artist.jpg'
    }
];
